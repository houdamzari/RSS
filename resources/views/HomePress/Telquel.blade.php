    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 text-center">
                <h1 id="fh5co-logo"><a href="{{ ('/today')}}">Tel quel <sup>Mr</sup></a></h1>
            </div>
            ...
            <div class="wrapper">
                <a class="card" href="#">
                    ...
                    <div class="card__content">
                        <p class="card__category">Tel quel</p>
...
<div style="height: 300px;width: 100%;"></div>@include('components.footer');
