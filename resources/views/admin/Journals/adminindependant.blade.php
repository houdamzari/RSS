...
<head>
    <title> Management | The Independant</title>
    <meta charset="utf-8">
                ...
                <div class="col-md-12">
                    <div class="card">
                        {{-- @if(session('success'))
                          ...
                          @endif--}}
                        <div class="card-header"> All The Independant Articles</div>
                            ...
                            @foreach($articles as $article )
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('independantDeleted/'.$article->id) }}" class="btn btn-danger">Delete</a>
                                    </td>
