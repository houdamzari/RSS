                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item"><a href="{{url('/independantDelete')}}" ></i>The Independant</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        {{-- @if(session('success'))
                          ...
                          @endif--}}
                        <div class="card-header"> All Rt Articles</div>
                            ...
                            @foreach($articles as $article )
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('rtDeleted/'.$article->id) }}" class="btn btn-danger">Delete</a>
                                    </td>
